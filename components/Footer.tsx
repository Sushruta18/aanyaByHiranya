  ...
  return (
    <footer className="bg-beige dark:bg-dark border-t border-forest/10 dark:border-beige/10 py-16 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
        <div>
          <p className="font-serif text-2xl text-forest dark:text-beige mb-3">Anya by Hiranya</p>
        ...
        <div>
          ...
          <div className="flex flex-col gap-2">
            {[["Works","/portfolio"],["About","/about"],["Journal","/blog"],["Workshops","/workshops"],["Contact","/contact"],["Commission","/commission"]].map(([l,h])=>(
        ...
        <div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <a href="https://instagram.com/anyabyhiranya" target="_blank" rel="noopener noreferrer"
      ...
      <div className="max-w-7xl mx-auto mt-12 pt-6 border-t border-forest/10 dark:border-beige/10">
        <p className="text-xs text-dark/40 dark:text-beige/40">© {new Date().getFullYear()} Anya by Hiranya. All rights reserved.</p>
      </div>
    </footer>
  );
}
