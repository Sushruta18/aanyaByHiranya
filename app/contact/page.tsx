        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
          <div>
            ...
            <div className="flex flex-col gap-4">
              <a href="mailto:Aaanyabyhiranya@gmail.com" className="text-sm text-dark/70 dark:text-beige/70 hover:text-forest dark:hover:text-rose transition-colors">
                ✉ Aaanyabyhiranya@gmail.com
              </a>
